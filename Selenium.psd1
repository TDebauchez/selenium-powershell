...
@{
    ...
    RequiredAssemblies   = @('./assemblies/WebDriver.dll', './assemblies/WebDriver.Support.dll', './assemblies/SeleniumExtras.WaitHelpers.dll', './assemblies/SeleniumExtras.PageObjects.dll')
    FunctionsToExport    = '*'
    AliasesToExport      = @()
    CmdletsToExport      = @()
    VariablesToExport    = @()
